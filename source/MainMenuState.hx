...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Poga Engine v" + psychEngineVersion, 12);
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				...
				{
					CoolUtil.browserLoad('https://youtu.be/dQw4w9WgXcQ?si=zJMt_c82uzjWdD4U');
				}
				else
				{
					selectedSomethin = true;
